...
1. Open ```MechanicOverview.scad``` and comment-out execution of all modules (render image should be clean)
1. ```python ./GenerateMultipleSTL.py MechanicOverview.sca```
2. ```./run_exports.sh``` - it will take a bit of time to finish.
